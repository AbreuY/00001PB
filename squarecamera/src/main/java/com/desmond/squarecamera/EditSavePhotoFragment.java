...
public class EditSavePhotoFragment extends Fragment {
    ...
    public static final int SIZE = 960*2;
...
private void rotatePicture(int rotation, byte[] data, ImageView photoImageView) {
    ...
    int size = Math.min(rawBitmap.getWidth(), rawBitmap.getHeight());

    Bitmap bitmap = ThumbnailUtils.extractThumbnail(rawBitmap, SIZE , SIZE, ThumbnailUtils.OPTIONS_RECYCLE_INPUT);
