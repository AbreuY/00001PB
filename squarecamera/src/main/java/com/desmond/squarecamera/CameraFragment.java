...
public class CameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    private static final int PICTURE_SIZE_MAX_WIDTH = 1280*4;
    private static final int PREVIEW_SIZE_MAX_WIDTH = 640*4;
    long maxTimeInMilliseconds = 4*1000;// in your case 4 minutes
    ...
    public void startTimer(final long finish, long tick)
    {
        CountDownTimer t = new CountDownTimer(finish, tick) {
            ...
            public void onTick(long millisUntilFinished)
            {
                ...
                int count = (int) remainedSecs;
                timer.setText(""+count);
                //timer.setText(count);// manage it accordign to you
            }
