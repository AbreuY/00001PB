...
public class ColorPickerDialog extends Dialog {
    private final boolean DEBUG = true;
      ...
      public BubbleTextView bubble = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int height = (int) (manager.getDefaultDisplay().getWidth() * 0.45f);
        int width = (int) (manager.getDefaultDisplay().getHeight() * 0.9f);
    ...
    private class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            drawTextCenter(canvas, targetRect, mCenterTextPaint, "Tap");
            // 是否显示中心圆外的小圆环
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    else if (downInRect && inRect) {// down The gradient inside the box, AND move Also within the gradient box
                        mCenterPaint.setColor(interpRectColor(mRectColors, x));
                    }
                    bubble.resetColor(mCenterPaint.getColor());

                    if (DEBUG)
                        Log.v(TAG, "[MOVE] Highlight: " + highlightCenter + "Microlight: " + highlightCenterLittle + " center: " + inCenter);
                    if ((highlightCenter && inCenter) || (highlightCenterLittle && inCenter)) {// Click the center circle,
                                                                                               //The current move in the center circle
