 ...
 */
public class SlidersLayout extends WalkthroughActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WalkthroughItem page1 = new WalkthroughItem(R.drawable.facebook_final,getString(R.string.walkthrough_1_title),getString(R.string.walkthrough_2_details));
